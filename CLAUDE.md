...
| 虚空 void | `#050505` | 页面底色 |
| 骨白 bone | `#F2EFE9` | 正文 |
| **克莱茵蓝** | `#0B37C8` | Scholarly（黑底提亮版） |
| **酒红** | `#96202F` | Creative（黑底提亮版） |
| **旧金** | `#806220` | Professional（黑底压暗版） |
| 三色原值 | `#002FA7` / `#6E1423` / `#B08D2E` | 保留为 `*-deep`，供亮底场景（打印、OG 图） |
...
首页是一个巨大的圆环，**三条线各占 120°**，中心留空放照片（`/coda` 入口）。悬停或聚焦某一扇区时，该色从中心扩张至页面边缘；其余两扇区降到 28% 不透明度。
