...
|---|---|---|
| 墨黑 ink | `#0B0B0B` | 正文 |
| 骨白 paper | `#F2EFE9` | 页面底色 |
| 石墨 graphite | `#45443F` | 次级文字 |
| 灰烬 ash | `#86847C` | 弱化文字、标签 |
| 界线 rule | `#D5D0C4` | 发丝线 |
| **克莱茵蓝** | `#002FA7` | Scholarly |
| **酒红** | `#6E1423` | Creative |
| **旧金** | `#B08D2E` | Professional |
...
**代价**：放弃了「暗色站点」这个对金属核审美更直觉的选项。若日后要做暗色主题，必须重新推导，不能简单反色——反色会同时毁掉克莱茵蓝和旧金。
...
- [x] 确定信息架构与视觉方案（见 §4、D7–D9）
- [x] 实现首页构图、三条线内页、`/coda`、`/cv`
