...
const zh: Partial<Dictionary> = {
  questionCopy: {
    ...
    "death-suffering": {
      ...
      note: "二者的现象学结构与价值并不相同，却都可能被归入“坏的经验”。不同文化如何赋予它们意义、又如何安置它们；它们对生者意味着什么；以及更具体地，失去、哀悼与创伤如何改变人格，而人格又如何反过来影响个体对这些经验的感受、解释与整合。",
    },
    selfhood: {
      // No full stop, and that is his. It is a question set as a statement.
      lead: "自我同一性本身是否是一种具有文化特异性的心理需求",
      note: "若答案是肯定的，那么许多以“形成稳定、整合的自我同一性”为发展目标的人格与发展理论，实际上都隐含着一道未被明确声明的文化边界。进一步地，我尤其想探讨意义感在其中所扮演的角色：它是否可能作为一种维持自我连续性的机制，使个体即使在身份、角色或价值发生变化时，仍能体验到跨时间的自我连贯性。",
    },
    intervention: {
