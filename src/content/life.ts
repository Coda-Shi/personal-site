...
/**
 * Coda's own account of himself, given 2026-08-17. Transcribed verbatim.
 *
 ...
 * into the long ones — the one-line paragraphs are doing the pacing.
 */
export const LIFE: Record<Locale, string[]> = {
  zh: [
    ...
    "生活里的我没有这么诗意。",
    "我会因为迷路和不会骑自行车，被朋友领着到处乱走。更多时候，我只是熬夜掉进维基百科的兔子洞，忘记回消息；因为记不住别人的名字，干脆一律叫“老师”或者“兄弟”；在 Steam 上买一些根本不会打开的游戏，买来的书大多只看到一半，间歇性运动，并且永远在减肥。",
    "有朋友说我是个非常复杂而多面的人。其实那些都是我，我只是很坦然地承认了而已。",
    "对了，这个网站上好像还没写过我喜欢兵击。简单来说，就是两个人穿着护具、拿着钢剑对抡。多少有点危险，但真的很过瘾。",
    "好在我还有一点不合时宜的幽默感，也还算知道什么东西好吃、什么酒好喝、什么作品值得安利给朋友。",
    "所以暂时还有人愿意和我出门。",
    "不然大概就是个山顶洞人。",
  ],
  en: [
    ...
    "Some friends tell me I'm an unusually complicated and multifaceted person. I think all of those sides are simply me. I've just become fairly comfortable admitting it.",
    ...
    "Fortunately, I have a slightly inappropriate sense of humor, and I'm reasonably good at knowing what food is worth trying, what drinks are worth having, and what books, films, music, and other works are worth recommending to friends.",
    "So, for now, people are still willing to go out with me.",
    "Otherwise, I'd probably be a caveman.",
  ],
};
