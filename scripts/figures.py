...
before changing a number in either. A mid-sagittal brain was drawn here too,
for as long as it took the owner to confirm that his reference was free to
distribute — after which a scan through figure-lineart.py beat it, as it does
for every figure with settled geometry. See the note on the brain's boxes in
symbol-field.tsx.
